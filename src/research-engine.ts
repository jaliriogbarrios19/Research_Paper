...
export async function generatePaper(
  ...
  const prompt =
    mode === "quick"
      ...
      : `Generate an academic literature synthesis in clean markdown format (no LaTeX, no code fences, no % comments, no &nbsp; HTML entities). This is a REVIEW paper, NOT original research — do NOT fabricate a Methods section or describe data analysis you did not perform. Use this APA 7th edition structure:${citationRule}
...
### Introduction
{Literature review body in ${langName} with in-text APA citations. Synthesize and critically discuss the sources.}

### Discussion and Conclusions
{Synthesize findings, identify gaps, suggest future research.}

### References
{APA 7 formatted references — no HTML entities, no &nbsp;, plain markdown}

IMPORTANT: This is a literature synthesis generated by AI. Do NOT invent a Methods section claiming content analysis, systematic review procedures, or data coding. Do NOT use medical analogies unless the sources themselves are medical. Write the paper in ${langName}.${extra}
